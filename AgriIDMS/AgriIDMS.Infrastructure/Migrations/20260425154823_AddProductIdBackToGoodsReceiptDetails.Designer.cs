...
namespace AgriIDMS.Infrastructure.Migrations
{
    ...
    [Migration("20260425154823_AddProductIdBackToGoodsReceiptDetails")]
    partial class AddProductIdBackToGoodsReceiptDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgriIDMS.Domain.Entities.DamageReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("ApprovedDamagedWeightKg")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");

                    b.Property<decimal?>("BoxWeightAtReportKg")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");

                    b.Property<decimal?>("BoxWeightSnapshotKg")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");
                    ...
                    b.Property<int?>("ProcessingOutcome")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("RequestedDamagedWeightKg")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");

                    b.Property<int?>("RequestedProcessingOutcome")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AgriIDMS.Domain.Entities.ExportReceipt", b =>
                {
                    ...
                    b.Property<string>("PrintDataSnapshotJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AgriIDMS.Domain.Entities.GoodsReceipt", b =>
                {
                    ...
                    b.Property<int>("InboundReceiptKind")
                        .HasColumnType("int");

                    b.Property<string>("NonPoReason")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<string>("PrintSnapshotAfterApproveJson")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PrintSnapshotAfterQcJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AgriIDMS.Domain.Entities.NearExpiryDiscountRule", b =>
                {
                    ...
                    b.HasIndex("IsActive", "Priority", "MaxDaysLeft");
            ...
            modelBuilder.Entity("AgriIDMS.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("PaymentDeadlineNotifiedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("PaymentDeadlineNotifiedAt");
            ...
            modelBuilder.Entity("AgriIDMS.Domain.Entities.ProductVariantDiscountOverride", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("OverrideNearExpiryDiscountPercent")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasIndex("ProductVariantId", "IsActive");

                    b.ToTable("ProductVariantDiscountOverrides", (string)null);
                });
            ...
            modelBuilder.Entity("AgriIDMS.Domain.Entities.PurchaseRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AgriIDMS.Domain.Entities.PurchaseRequestDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AgriIDMS.Domain.Entities.QcClassificationDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("QcRecordId");

                    b.ToTable("QcClassificationDetails", (string)null);
                });

            modelBuilder.Entity("AgriIDMS.Domain.Entities.QcRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("DamagedWeight")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");
                    ...
                    b.Property<decimal>("InspectedWeight")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");

                    b.Property<decimal>("PassedWeight")
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)");
            ...
            modelBuilder.Entity("AgriIDMS.Domain.Entities.DamageReport", b =>
                {
                    ...
                    b.HasOne("AgriIDMS.Domain.Entities.ApplicationUser", "ReportedByUser")
                        .WithMany()
                        .HasForeignKey("ReportedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AgriIDMS.Domain.Entities.ApplicationUser", "ReviewedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("AgriIDMS.Domain.Entities.PurchaseRequestDetail", b =>
                {
                    ...
                    b.HasOne("AgriIDMS.Domain.Entities.PurchaseRequest", "PurchaseRequest")
                        .WithMany("Details")
            ...
            modelBuilder.Entity("AgriIDMS.Domain.Entities.QcClassificationDetail", b =>
                {
                    b.HasOne("AgriIDMS.Domain.Entities.ProductVariant", "ProductVariant")
                        .WithMany("QcClassificationDetails")
                        .HasForeignKey("ProductVariantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AgriIDMS.Domain.Entities.QcRecord", "QcRecord")
                        .WithMany("ClassificationDetails")
                        .HasForeignKey("QcRecordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProductVariant");

                    b.Navigation("QcRecord");
                });
            ...
            modelBuilder.Entity("AgriIDMS.Domain.Entities.QcRecord", b =>
                {
                    b.HasOne("AgriIDMS.Domain.Entities.GoodsReceiptDetail", "GoodsReceiptDetail")
                        .WithOne("QcRecord")
                        .HasForeignKey("AgriIDMS.Domain.Entities.QcRecord", "GoodsReceiptDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AgriIDMS.Domain.Entities.ProductVariant", b =>
                {
                    b.Navigation("DiscountOverrides");
                    ...
                    b.Navigation("QcClassificationDetails");
            ...
            modelBuilder.Entity("AgriIDMS.Domain.Entities.QcRecord", b =>
                {
                    b.Navigation("ClassificationDetails");
                });
